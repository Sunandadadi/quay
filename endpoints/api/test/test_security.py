...
SECURITY_TESTS: List[
    ...
    (OrganizationQuota, "POST", {"namespace": "buynlarge"}, {"limit_bytes": 1, "bytes_unit": "GB"}, None, 401),
    (OrganizationQuota, "GET", {"namespace": "buynlarge"}, None, None, 401),
    (OrganizationQuota, "PUT", {"namespace": "buynlarge"}, {"limit_bytes": 1, "bytes_unit": "GB"}, None, 401),
    (
